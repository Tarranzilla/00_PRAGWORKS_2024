...
const TodasAsSolucoes: SolutionType[] = [
    {
        ...
        class: "atendimento",
        fullDescription:
            "Automatizar tarefas repetitivas e contínuas permite que os funcionários se concentrem em atividades que exigem mais habilidade e criatividade. Disponibilize robôs de guia que possam auxiliar as pessoas e fornecer informações e descrições precisas em ambientes públicos. Aumente a segurança e a privacidade em pesquisas públicas, proporcionando soluções avançadas de reconhecimento facial e análise de dados.",
        description:
        ...
        imgSrc: ["/experience_images/exp_cajuru.png", "/experience_images/exp_condor.png", "/experience_images/exp_bioos.png"],
...

    {
        ...
        class: "publicidade",
        fullDescription:
            "Ofereça soluções de publicidade interativa durante eventos, permitindo a interação com potenciais clientes e coletando informações valiosas para análise de dados.",
        description:
...

    {
        ...
        class: "inspecao",
        fullDescription:
            "Realize rondas e vistorias recorrentes em ambientes comerciais e industriais, proporcionando maior segurança e controle de qualidade.",
        description:
...

    {
        ...
        class: "transporte",
        fullDescription:
            "Transporte facilmente pequenos objetos de um ponto a outro, permitindo a redução de custos e aumentando a eficiência operacional.",
        description:
