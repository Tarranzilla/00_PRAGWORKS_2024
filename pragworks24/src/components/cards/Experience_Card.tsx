...
export default function Experience_Card({ product: { domId, id, prename, name, type, heroImg, backgroundImg, detail_images, textIntro } }) {
    ...
    return (
        <div className="Product_Card Experience_Card" id={domId}>
            ...
            <img className="Card_Product_Image Product_Main_Image Experience_Card_Image" src={heroImg}></img>
